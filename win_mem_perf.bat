...
:OK
Echo Memory OK, %mem%%% Used ^|'Memory_Used'=%mem%;;;;'Free_Memory'=%freemem%;;;;'Totoal_Memory'=%totalMem%;;;;
exit 0
:WARN
Echo Memory Warning, %mem%%% Used ^|'Memory_Used'=%mem%;;;;'Free_Memory'=%freemem%;;;;'Totoal_Memory'=%totalMem%;;;;
exit 1
:CRITICAL
Echo Memory CRITICAL, %mem%%% Used ^|'Memory_Used'=%mem%;;;;'Free_Memory'=%freemem%;;;;'Totoal_Memory'=%totalMem%;;;;
exit 2
